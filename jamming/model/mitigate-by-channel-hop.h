...
#ifndef MITIGATE_BY_CHANNEL_HOP_H
#define MITIGATE_BY_CHANNEL_HOP_H
 ...
 */
class MitigateByChannelHop : public JammingMitigation
{
public:
  /**
...
public:
  ...
  MitigateByChannelHop ();
  virtual ~MitigateByChannelHop ();
...
private:
  ...
  virtual void StartDetection(Ptr<Packet> packet, double averageRss);
