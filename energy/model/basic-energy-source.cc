...
BasicEnergySource::UpdateEnergySource (void)
{
  ...
  NS_LOG_DEBUG ("m_remainingEnergyJ" << m_remainingEnergyJ);
  NS_LOG_DEBUG ("m_depleted" << m_depleted);
  NS_LOG_DEBUG ("m_lowBatteryTh" << m_lowBatteryTh);
   NS_LOG_DEBUG ("m_initialEnergyJ" << m_initialEnergyJ);
  NS_LOG_DEBUG ("BasicEnergySource:Updating remaining energy." << (!m_depleted && m_remainingEnergyJ) );
...
BasicEnergySource::CalculateRemainingEnergy (void)
{
  ...
  Time duration = Simulator::Now () - m_lastUpdateTime;
   NS_LOG_FUNCTION("calcul de nouveau energie" << duration.GetNanoSeconds ());
